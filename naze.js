...
//PEMBATAS CONVERT=======================================
            ...
            m.reply ('Jangan Lupa Bilang Makasih :')
...
╰──❍`
  ...
  naze.sendMessage(m.chat, buttonMessage, {quoted: fkontak})
  men = fs.readFileSync('./media/audio/song.mp3')
         await naze.sendMessage(m.chat, { audio: men, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
            	}
 break
