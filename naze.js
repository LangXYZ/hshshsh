...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 ...
 //PEMBATAS MENUKU
       ...
       case 'cekpintar': {
          ...
          case 'setname': {
           ...
           case 'setppgroup': case 'setppgrup' : case 'setppgc': {
            ...
            case 'hai': case 'hallo': case 'halo': case 'p': case 'assalamualaikum': case 'punten': case 'bot': case 'gimana': case 'cara': case 'apa': case 'kok': case 'gabisa': {
       m.reply ('hallo silahkan Ketik Prefix + Command Ya')
       break
		    }
	 case 'mksih': case 'thx': case 'thank': case 'good': case 'nuhun': case 'domo': case 'makasih': case 'done': {
    ...
    case 'belibot': case 'stopjadibot': case 'sewabot': case 'buybot': {
